...
HTAData_RASA_WithoutJunctions_OutputREIDSModel=GenoDiffSplicing(geneData=HTAData_RASA,nsim=5000,geneID=HTAData_RASA$GeneID,informativeCalls=TRUE,alpha=0.5)
