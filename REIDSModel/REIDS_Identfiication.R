...
#	
	...
	JoinedFile=JoinedFile[,c(2,1,3,4,5,6,8,9,10,11,12,13)]
	colnames(JoinedFile)=c("GeneID","PSR_ID","ExonScore","t.statistic","p.value","adj.p.value","psr_type","prs_id","JUC_ID","junction_type","junction_id","as_type")
