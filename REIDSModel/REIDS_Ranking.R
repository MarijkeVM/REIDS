...
#						}
					...
					if(length(Del)>0){
						if(length(Del)==length(Junctions)){
							Row=c(as.character(ASPSR),Junctions[1],Junctions[2],100000,"No Annot Junction")
							return(Row)
						}
						else{
							Row=c(as.character(ASPSR),Junctions[1],Junctions[2],100000,"No Annot Junction")
...
#						}
					...
					if(length(Del)>0){
						if(length(Del)==length(Junctions)){
							Row=c(as.character(ASPSR),Junctions[1],Junctions[2],100000,100000,"No Annot Junction")
							return(Row)
						}
						else{
							Row=c(as.character(ASPSR),Junctions[1],Junctions[2],100000,100000,"No Annot Junction")
