...
PlotFunction<-function(GeneID=NULL,ExonID=NULL,Data,GDS_Output,GeneLevelData=NULL,ExonLevelData=NULL,FIRMA_Data=NULL,groups,ylabel=NULL,plottype="new",location,title=""){
...
#	print(t.test(x=Gene_GeneID[1,group1],y=Gene_GeneID[1,group2]))
	...
	plot(0,0,typ="n",xlab="",ylab=ylabel,ylim=c(0,max_ylim+2),xlim=c(1,ncol(ProbeIntensities_ExonID)),xaxt="n",frame=TRUE)
	...
	axis(1,labels=colnames(Gene_GeneID),at=c(1:ncol(ProbeIntensities_ExonID)),las=2,cex.axis=1.5)	
...
#                                            1    2
# 1  JUC0100236286|JUC0100236573|JUC0100236628 TRUE
# 6                              JUC0100032584 TRUE
# 7                JUC1700094688|JUC1700094690 TRUE
# 10                             JUC0200020308 TRUE
# 17 JUC0100065897|JUC0100065932|JUC0100066275 TRUE
# 36                                           TRUE
...
# [1] 10838
## probe sets with 2 linking junctions, both are supporting and exclusion junction support
length(which(REIDS_RankedProbesets[,6]==""&round(REIDS_RankedProbesets[,4],2)>0.05&REIDS_RankedProbesets[,8]==TRUE))
# [1] 6372
length(which(REIDS_RankedProbesets[,6]==""&round(REIDS_RankedProbesets[,4],2)>0.05&REIDS_RankedProbesets[,8]==FALSE))
# [1] 120

## probe sets with 2 linking junctions but has a sign interaction term
length(which((REIDS_RankedProbesets[,6]=="1 of two junctions is supporting")&round(REIDS_RankedProbesets[,4],2)<=0.05&REIDS_RankedProbesets[,8]==TRUE))
# [1] 2875
length(which((REIDS_RankedProbesets[,6]=="1 of two junctions is supporting")&round(REIDS_RankedProbesets[,4],2)<=0.05&REIDS_RankedProbesets[,8]==FALSE))
# [1] 78
2875+78+120
# [1] 3073
## probe sets with 2 linking junctions and none is supporting but excl is
length(which(REIDS_RankedProbesets[,6]==""&round(REIDS_RankedProbesets[,4],2)<=0.05&REIDS_RankedProbesets[,8]==TRUE))
# [1] 1357
## no support
length(which(REIDS_RankedProbesets[,6]==""&round(REIDS_RankedProbesets[,4],2)<=0.05&REIDS_RankedProbesets[,8]==FALSE))
...
# [1] 5062
## probe sets with 1 linking junction and supporting excl
length(which(REIDS_RankedProbesets[,6]=="Only 1 type of junction"&REIDS_RankedProbesets[,4]>0.05&REIDS_RankedProbesets[,8]==TRUE))
# [1] 3337
## probe sets with 1 linking junction and supporting excl
length(which(REIDS_RankedProbesets[,6]=="Only 1 type of junction"&REIDS_RankedProbesets[,4]>0.05&REIDS_RankedProbesets[,8]==FALSE))
# [1] 118
118+3337
# [1] 3455
## probe sets with 1 linking junction but not supporting but an supporting excl junction
length(which(REIDS_RankedProbesets[,6]=="Only 1 type of junction"&REIDS_RankedProbesets[,4]<0.05&REIDS_RankedProbesets[,8]==TRUE))
# [1] 1558
length(which(REIDS_RankedProbesets[,6]=="Only exclusion junctions"&REIDS_RankedProbesets[,8]==TRUE))
# [1] 2833
2833+1558
# [1] 4391
## have annotations but no support
length(which(REIDS_RankedProbesets[,6]=="Only 1 type of junction"&REIDS_RankedProbesets[,4]<0.05&REIDS_RankedProbesets[,8]==FALSE))
# [1] 49
length(which(REIDS_RankedProbesets[,6]=="Only exclusion junctions"&REIDS_RankedProbesets[,8]==FALSE))
# [1] 148
49+148
# [1] 197
...
# [1] 9196 
length(intersect(Con,RASA$PSR_ID))
# [1] 3341
length(intersect(Flex,RASA$PSR_ID))
# [1] 9080


## probe sets with 2 linking junctions, both are supporting and exclusion junction support
Con=REIDS_RankedProbesets[which(REIDS_RankedProbesets[,6]==""&round(REIDS_RankedProbesets[,4],2)>0.05&REIDS_RankedProbesets[,8]==TRUE),1]
# [1] 6372
Flex=c(Con,REIDS_RankedProbesets[which((REIDS_RankedProbesets[,6]=="1 of two junctions is supporting")&round(REIDS_RankedProbesets[,4],2)<=0.05&REIDS_RankedProbesets[,8]==TRUE),1],
REIDS_RankedProbesets[which(REIDS_RankedProbesets[,6]==""&round(REIDS_RankedProbesets[,4],2)<=0.05&REIDS_RankedProbesets[,8]==TRUE),1],
REIDS_RankedProbesets[which((REIDS_RankedProbesets[,6]=="1 of two junctions is supporting")&round(REIDS_RankedProbesets[,4],2)<=0.05&REIDS_RankedProbesets[,8]==FALSE),1],
REIDS_RankedProbesets[which(REIDS_RankedProbesets[,6]==""&round(REIDS_RankedProbesets[,4],2)>0.05&REIDS_RankedProbesets[,8]==FALSE),1],
REIDS_RankedProbesets[which(REIDS_RankedProbesets[,6]=="Only 1 type of junction"&REIDS_RankedProbesets[,4]>0.05&REIDS_RankedProbesets[,8]==FALSE),1],		
REIDS_RankedProbesets[which(REIDS_RankedProbesets[,6]=="Only 1 type of junction"&REIDS_RankedProbesets[,4]<0.05&REIDS_RankedProbesets[,8]==TRUE),1],		
REIDS_RankedProbesets[which(REIDS_RankedProbesets[,6]=="Only exclusion junctions"&REIDS_RankedProbesets[,8]==TRUE),1],
REIDS_RankedProbesets[which(REIDS_RankedProbesets[,6]=="Only 1 type of junction"&REIDS_RankedProbesets[,4]>0.05&REIDS_RankedProbesets[,8]==TRUE),1])
...
length(intersect(Con,as.character(VerifiedProbes_PSRID[,2])))
# [1] 92
length(intersect(Flex,as.character(VerifiedProbes_PSRID[,2])))
# [1] 292
